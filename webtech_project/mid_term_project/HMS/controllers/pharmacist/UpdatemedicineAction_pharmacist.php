    ...
    if($_SERVER['REQUEST_METHOD']==="POST"){
        ...
        if($isValid){
            ...
            if(file_exists($filename)){
                ...
                $data=array("product_id"=>$array_data[$_SESSION['idx']]['product_id'], "product_name"=>$mname, "product_stock"=>$mstock, "unit_price"=>$munit);
                $array_data[$_SESSION['idx']]=$data;
                $final_data=json_encode($array_data);
			    file_put_contents($filename,$final_data);
            }else{
                $_SESSION['msg_global']="Data does not exist!";
                header("Location: ../../views/pharmacist/Updatemedicine_pharmacist.php");
            }
        }else{
            //invalid
            header("Location: ../../views/pharmacist/Updatemedicine_pharmacist.php");
        ...
        header("Location: ../../views/pharmacist/Updatmedicine_pharmacist.php");
    }
