...
<body>
    <h1>Doctor Login</h1>
    <form method="post" action="../../controllers/doctor/LoginAction_doctor.php" novalidate>
        ...
        <p>New User? <a href="Signup_doctor.php">Signup here.</a></p>
        <p>Forgot Password? <a href="Forgotpass_doctor.php">Reset now.</a></p>
    </form>
